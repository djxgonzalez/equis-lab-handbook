...
[*add link to sample daily log + template*]
...
## Talk about authorship

Good to have this conversation early... 
Set expectations...

The International Committee of Medical Journal Editor has four [recommended criteria](https://www.icmje.org/recommendations/browse/roles-and-responsibilities/defining-the-role-of-authors-and-contributors.html){target="_blank"} for authorship in peer reviewed manuscripts:

> Substantial contributions to the conception or design of the work; or the acquisition, analysis, or interpretation of data for the work; AND Drafting the work or reviewing it critically for important intellectual content; AND

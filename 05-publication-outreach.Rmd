...
Many journals now allow authors who want their work to be open access to pay an article processing charge (APC) to offset any lost revenue from subscribers. Journal APCs range widely. For example, the journal *[Environmental Epidemiology](https://journals.lww.com/environepidem/Pages/openaccess.aspx){target="_blank"}*, supported by the non-profit International Society for Epidemiology, charges an APC of $1,260 USD. On the other end of the spectrum, *[Nature Climate Change](https://www.nature.com/nclimate/submission-guidelines/publishing-options)* has an APC of \$12,290 USD.
